declare namespace SwalTypes {
    ...
    export interface SwalCore {
         ...
         */
        fire(title?: string, message?: string, icon?: SweetAlertIcon): Promise<SweetAlertResult>;
         ...
         */
        argsToParams(params: SweetAlertArrayOptions | [SweetAlertOptions]): SweetAlertOptions;
    }
    ...
    export interface SweetAlertResult {
        value?: any;
        dismiss?: SwalTypes.DismissReason;
    }
...
declare var Swal: SwalTypes.SwalCore;
